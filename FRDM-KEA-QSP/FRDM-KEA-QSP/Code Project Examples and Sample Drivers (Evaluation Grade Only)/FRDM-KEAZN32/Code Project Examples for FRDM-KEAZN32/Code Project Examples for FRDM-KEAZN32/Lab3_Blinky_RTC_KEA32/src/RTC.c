...
void RTC_Init()
{
	...
	RTC_SC|=RTC_SC_RTCPS(0b111);		/* RTC prescaler of 1000, 16Mhz/1000=16 kHz, RTC counter increases every 62.5 us */
	RTC_SC|=RTC_SC_RTCO_MASK;			/* Enable RTCO output which toggles pin at every overflow of RTC counter*/
	SIM_PINSEL|=SIM_PINSEL_RTCPS_MASK; /* RTCO in PTC5 */
	RTC_MOD = 8000;  					/* Interrupts every 8000*50 us = 500 ms*/
}
