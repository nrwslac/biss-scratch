...
#endif
#ifdef MCU_SKEAZ1284
  SIM_PINSEL1 |= SIM_PINSEL1_UART1PS_MASK; /* Set Pin out for UART1 at  PTF2 and PTF3, to SBC_LIN_RX and SBC_LIN_TX, respectively. */
#elif defined(MCU_SKEAZN642)
  /* Pin out for UART0 at PTC6 and PTC7, to SBC_LIN_RX and SBC_LIN_TX, respectively. Chip Default */
#else
  /*Write the SIM Pin Select for your device*/
  dummy; //That way you have to get an error until you put your own pin select
#endif
