...
void FTM2_Init_Output_Cmp()
{
	...
	FTM2_SC |= FTM_SC_PS(7);	/* Select Preescaler in this case 128. 16 Mhz /128 =125 Khz. */
								/* Counter increase by one every 8 us */
...
void FTM2_Init_EPWM()
{
	...
	FTM2_MOD = 6666;
	FTM2_SC = 0;
	FTM2_SC |= FTM_SC_PS(0);			/* Select Prescaler in this case 1. So no division of 16 Mhz */
