	...
	if ( ftm->pins->pin[channel].pin_code != GPIO_INVALID_PIN)
	{
		...
		else /* FTM2*/ 
		{
			...
			case 3: // Set or clear FTM2PS3 flag in PINSEL1 
				...
				break;
				/*Migrated from KEAZ128 to KEAZN64 so FTM2 in KEAZN64 doesn't have channels 4 and 5*/
			//case 4: // Set or clear FTM2PS4 flag in PINSEL1
				//SIM_PINSEL = ftm->pins->pin[channel].alt_num ? SIM_PINSEL1 | SIM_PINSEL1_FTM2PS4_MASK : SIM_PINSEL1 & ~SIM_PINSEL1_FTM2PS4_MASK;
				//break;
			//case 5: // Set or clear FTM2PS5 flag in PINSEL1
				//SIM_PINSEL = ftm->pins->pin[channel].alt_num ? SIM_PINSEL1 | SIM_PINSEL1_FTM2PS5_MASK : SIM_PINSEL1 & ~SIM_PINSEL1_FTM2PS5_MASK;
				//break;
			}
